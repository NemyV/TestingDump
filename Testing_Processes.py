...
def minimap_detection(switch):
    count_occurrance = 0
    while 'On' not in switch:
        time.sleep(1)
        print("minimap Detection")
    # while True:
    ...
    #                                 if search != [-1, -1] or countingportattempt >= 2:
    #                                     x1, y1 = process_search(search)
